    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offer_discount', models.DecimalField(blank=True, decimal_places=0, max_digits=2, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_code', models.CharField(blank=True, max_length=254)),
                ('total_after_discount', models.DecimalField(blank=True, decimal_places=2, max_digits=6, null=True)),
                ('discount', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='checkout.discount')),
